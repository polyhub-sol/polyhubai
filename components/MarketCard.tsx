  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2 text-[10px] text-ov-text-muted">
        {market.end_date && (
          <span className="rounded-full border border-ov-border/50 bg-black/35 px-2 py-0.5">
      ...
      <div className="mt-4 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center whitespace-nowrap rounded-full bg-gradient-to-r from-purple-400/95 to-cyan-300/95 px-4 py-1.5 text-xs font-semibold leading-tight text-black transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            <span>AI View</span>
          </Link>
        </div>

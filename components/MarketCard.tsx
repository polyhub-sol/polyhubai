...
export function MarketCard({ market }: Props) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex h-full flex-col rounded-2xl border border-ov-border/70 bg-gradient-to-br from-black/80 via-ov-bg-soft/90 to-black/80 p-4 shadow-ov-soft cursor-pointer"
    >

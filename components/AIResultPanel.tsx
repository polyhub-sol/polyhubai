    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 rounded-full border border-ov-border/70 bg-black/60 px-3 py-1.5 text-[11px] font-medium text-ov-text-muted hover:border-ov-accent hover:text-white disabled:opacity-50 transition-colors duration-150"
        >
          {loading ? (
      ...
      {analysis ? (
        ...
        <div className="rounded-2xl border border-dashed border-ov-border/60 bg-black/40 p-4 text-sm text-ov-text-muted">

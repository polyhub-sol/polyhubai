  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      ...
      <div className="space-y-6">
        {/* Orders Section */}
        <div className="rounded-2xl border border-ov-border/70 bg-black/60 p-6 shadow-ov-soft">
        ...
        <div className="rounded-2xl border border-ov-border/70 bg-black/60 p-6 shadow-ov-soft">
          ...
          <div className="rounded-xl border border-dashed border-ov-border/60 bg-black/40 p-8 text-center">
            <svg
